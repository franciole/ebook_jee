...
public class ObjectoCampoConsulta implements Serializable, Comparator<ObjectoCampoConsulta> {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ObjectoCampoConsulta other = (ObjectoCampoConsulta) obj;
		if (campoBanco == null) {
	...
	@Override
	public int compare(ObjectoCampoConsulta o1, ObjectoCampoConsulta o2) {
		return ((ObjectoCampoConsulta) o1).getPrincipal().compareTo(((ObjectoCampoConsulta) o2).getPrincipal());
	}
